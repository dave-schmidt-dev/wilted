...
area: ["src/wilted/classify.py", "src/wilted/discover.py", "src/wilted/prepare.py", "src/wilted/report.py", "src/wilted/cli.py", "src/wilted/transcribe.py", "src/wilted/speech_ready.py", "src/wilted/pipeline_submit.py", "src/wilted/scheduler_tick.py", "scripts/wilted-nightly.sh", "src/wilted/station_runtime/weather_monitor.py", "scripts/wilted-weather-monitor.sh"]
