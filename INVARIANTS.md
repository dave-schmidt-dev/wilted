...
area: ["src/wilted/classify.py", "src/wilted/discover.py", "src/wilted/prepare.py", "src/wilted/report.py", "src/wilted/cli.py", "scripts/wilted-nightly.sh", "src/wilted/station_runtime/weather_monitor.py", "scripts/wilted-weather-monitor.sh"]
